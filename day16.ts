...
// solution
type _FindSanta<T, U = '🎅🏼', O extends any[] = []> =
  T extends [infer F, ...infer R] ?
    F extends U ? O['length'] : _FindSanta<R, U, [...O, 0]>
  : null;

type FindSanta<T, RowIndex extends any[] = []> =
  T extends [infer Row, ...infer RestRows] ?
    _FindSanta<Row> extends infer I extends number ?
       [RowIndex['length'], I]
    : FindSanta<RestRows, [...RowIndex, 0]>
  : never;
